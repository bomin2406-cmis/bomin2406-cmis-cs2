...
def intro():
	...
	target = random.randint(1, 3)
		...
		if cut == target:
			return "YAAASSSSS YOU ARE ALIVE. YAS YAS BUT BUT THE BOMB THOUGH. the timer's still running.....!"
		else:
			print "BOOM. YOU'RE DEAD."

	cut2 = raw_input("Next circuit! What color is the circuit you would like to cut now? ALL IN LOWER CASE PLEASE:")
		if cut2 == target:
			return "...............the.bomb.is.stopped.YOU WIN BRO."
		else:
			print "AW. BOOOOOOOOM. YOU'RE DEAD."
